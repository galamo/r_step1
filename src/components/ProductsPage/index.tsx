...
// class Prod implements IProduct {
//   constructor(public id: number, public sku: number, public title: string) {}
// }

export class ProductsPage extends React.Component<
  any,
  { products: Array<IProduct>; search: string; filteredProducts: IProduct[] }
> {
  state = { products: data, search: "", filteredProducts: data };
  ...
  render() {
    return (
      <div>
        <input
          onChange={e => {
            if (!e.target.value) this.setState(this.state);
        ...
        {getProducts(this.state.filteredProducts)}
      </div>
    );
  }
}
